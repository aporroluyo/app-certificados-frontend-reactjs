...
export const Navbar = (): JSX.Element => {
  ...
  return (
    <nav className="bg-white flex lg:items-center lg:justify-between flex-wrap h-auto lg:h-14">
      ...
      >
        <div
          className={`w-full text-sm lg:flex lg:flex-grow lg:justify-between transition-all ease-in-out duration-300 max-lg:overflow-hidden ${
            showMenu ? 'block h-full' : 'hidden h-0'
          }`}
        >
